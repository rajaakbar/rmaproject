...
public class WCAG
{
    ...
    {
        final StringBuilder sb = new StringBuilder();
        sb.append("The ").append(violations.length()).append(" violations are detailed below:-");
     ...
     * @param output
     *            Object to write. Most useful if you pass in either the Builder.analyze() response or the
    ...
    public static class Builder
    {
        ...
        public Builder(final WebDriver driver, final URL script)
        {
            ...
            WCAG.inject(this.driver, this.script);
        }
